...
$TestScore = b_0 + b_1 \cdot ClassSize + e_1$

$TestScore = b_0 + b_1 \cdot ClassSize + b_2 \cdot TeacherQuality + e_2$

$TestScore = b_0 + b_2 \cdot TeacherQuality + b_3 \cdot SES + e_3$

$TestScore = b_0 + b_1 \cdot ClassSize + b_3 \cdot SES + e_4$

$TestScore = B_0 + B_1 \cdot ClassSize + B_2 \cdot TeacherQuality + B_3 \cdot SES + \epsilon$
...
Warm-up: Interpret the slope associated with Class Size in Model 01. What does a slope of `r coef(m1)[2]` mean in this context? Is the negative sign a good thing or a bad thing?  
