...
stargazer( m1, m2, type="html", digits=0,
           ...
           covariate.labels = c("a0/b1: Constant", 
                                "a1: female", 
                                "a2: minority",
...
Note that you can check your answers below by calculating the salaries two ways (one using Model 1 and one using Model 2). 
