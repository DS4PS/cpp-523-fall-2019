...
par( mar=c(4,0,0,0) )
jplot( caffeine, heart.rate, lab1="Average Caffeine Consumed by Each Group", 
       lab2="", # lab2="Average Heart Rate by Group", 
...
Since squaring terms ensures they are always positive, the quickest fix to this problem is to use the sum of squared deviations.
...
Now note the pattern here and the role the regression line ($\hat{y}$) serves: 
